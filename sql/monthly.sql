...
WHERE u.uid = { UID } -- change to your User ID
    ...
    AND (
        u.finished BETWEEN '2024-11-01' AND '2024-11-30' -- finished this month
        OR (
            u.finished IS NULL
            AND NOT u.started > '2024-11-30' -- WIP/Dropped/Stalled
            AND NOT (
                u.started < '2024-11-01' -- excluded earlier VNs
                AND NOT labels @> '{1}'
            )
        )
    )
